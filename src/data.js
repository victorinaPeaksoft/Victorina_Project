export const data = {
  ...
  {
    question: 'В тишине ты чувствуешь себя неуютно и стараешься чем-то заполнить ее?',
    answers: [
        {
          variant: "Часто",
          key: 1
  ...
  {
    question: "Хорошо ли вы помните зло, которое вам причинили другие люди?",
    answers: [
      {
        variant: "Иногда",
        key: 1,
  ...
  {
    question: "Можете ли вы успешно справляться сразу с несколькими задачами?",
    answers: [
      {
        variant: "Да",
        key: 1,
  ...
  },
  {
    ...
    answers: [
      ...
      {
        variant: "Речь быстрая и сопровождается выразительными мимикой и жестами",
        key: 2,
      },
      {
